...
export default function HomeContent() {
  ...
  return (
    <div className="flex h-screen w-full flex-col bg-gradient-to-b from-slate-50 to-gray-100/80 text-gray-900 font-sans">
      ...
      <ChatSidebar open={sidebarOpen} onClose={() => setSidebarOpen(false)} sessions={sessions} currentSessionId={currentSessionId} onLoadSession={loadSession} onDeleteSession={deleteSession} onNewChat={handleNewChat} onHistoryAction={historyAction} />
